...
export default function PatientRendezVous() {
    ...
    const cancelRendezVous = async (rdvId) => {
        ...
        try {
            const res = await fetch(`http://localhost:4000/rendezvous/${rdvId}`, {
                method: "DELETE",
                headers: {
                    "Authorization": `Bearer ${localStorage.getItem("token")}`
                }
        ...
        <>
            ...
            <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 font-inter relative overflow-hidden">
                ...
                <main className="max-w-6xl mx-auto px-6 py-8 relative z-10">
                    {/* Section Prise de Rendez-vous - Version Professionnelle */}
                    <div className="bg-white/80 backdrop-blur-lg rounded-2xl p-8 border border-gray-200/60 hover:shadow-lg transition-all duration-300 mb-8">
                ...
                <footer className="bg-white/80 backdrop-blur-lg border-t border-gray-200/60 mt-12 relative z-10">
                    <div className="max-w-7xl mx-auto px-6 py-6">
                        <div className="flex items-center justify-between">
                            <div className="flex items-center space-x-3">
                                <div className="w-8 h-8 bg-gradient-to-br from-violet-600 to-purple-500 rounded-lg flex items-center justify-center shadow-lg">
                                    <i className="fas fa-chart-line text-white text-sm"></i>
                                </div>
                                <span className="text-lg font-bold text-gray-900">VIZPILOT</span>
                            </div>
