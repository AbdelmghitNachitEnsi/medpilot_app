...
Question utilisateur : ${message}`
  ...
  if (!seenWelcome) {
    addMessage(
      "bot",
      `👋 Salam ${username}! Je suis MEDPILOT, votre assistant médical. Posez-moi une question médicale.`
    );
    localStorage.setItem("seenWelcome", "true"); // mark as seen
  }
}, [username]);
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col items-center p-5 font-sans">
      ...
      <div className="flex flex-col w-full max-w-2xl bg-white shadow-md rounded-lg p-4">
        <div
          id="chatBox"
  className="flex-1 overflow-y-auto h-96 p-2 mb-4 space-y-2 scrollbar-thin scrollbar-thumb-blue-500 scrollbar-track-gray-200 scroll-smooth"        ></div>
