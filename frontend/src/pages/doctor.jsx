...
export default function Doctor() {
    ...
    return (
        <>
            <Head>
                <title>VIZPILOT - Dashboard Docteur</title>
                            ...
                            <div className="bg-white/80 backdrop-blur-lg rounded-2xl p-6 border border-gray-200/60 hover:shadow-lg transition-all duration-300">
                                <div className="flex items-center justify-between mb-6">
                                    <div className="flex items-center space-x-3">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-gray-500 text-sm">Toutes vos consultations</p>
                                        </div>
                                    </div>
                                ...
                                {rendezvous.length === 0 ? (
                                    <div className="text-center py-8">
                                        ...
                                        <h3 className="text-lg font-medium text-gray-600 mb-2">Aucune consultation</h3>
                                    ...
                                    <div className="space-y-3">
                                        {rendezvous.slice(0, 5).map((rdv) => {
                                            ...
                                            return (
                                                <div
                                                    key={rdv.id}
                                                    className="flex items-center justify-between p-3 bg-gradient-to-r from-gray-50 to-white rounded-lg border border-gray-200/60 hover:border-blue-300 hover:shadow-sm transition-all duration-200"
                                                >
                                                    <div className="flex items-center space-x-3">
                                                        ...
                                                        <div>
                                                            ...
                                                            <p className="text-gray-500 text-xs">{rdv.date} à {rdv.heure}</p>
                                                        </div>
                                                    </div>
                                                    <span className={`px-2 py-1 rounded text-xs font-medium ${
                                                        isPast
                                                            ? 'bg-gradient-to-r from-gray-100 to-gray-200 text-gray-600 border border-gray-300'
                                                            : 'bg-gradient-to-r from-green-100 to-emerald-100 text-green-600 border border-green-300'
                                                    }`}>
